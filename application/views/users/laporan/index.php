              ...
              ?>
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">TABEL DAFTAR LAPORAN</h4>
                        </div>
                        <div class="panel-body">
													<div class="row">
														<div class="col-md-12"><b>DFilter Laporan</b></div>
														<div class="col-md-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-1">
                            <button class="btn btn-default"
                                    onclick="window.location.href='laporan/v/'+$('#stt').val();"><i
                            ...
                            foreach ($query->result() as $baris):?>
                                <tr>
                                    ...
                                    <td><?php
                                        ...
                                        $idNotarisOnuser = $baris->notaris;
                                        $tempatNotaris = $this->db->get_where('tbl_data_notaris', array('id_user' => $idNotarisOnuser))
                                                ->row()->tempat_kedudukan ?? 'Tempat Kedudukan Belum di-Update';
                                        echo $tempatNotaris;
                                        ?>
                                    </td>
                                    <td align="center">
                                        ...
                                        <?php if ($level == 'superadmin') { ?>
                                            <?php if ($baris->status == 'proses') { ?>
                                                <a href="javascript:;" class="btn btn-primary btn-xs" title="Konfirmasi"
                                                   data-toggle="modal"
                                                   onclick="modal_show(<?php echo $baris->id_laporan; ?>);"><i
