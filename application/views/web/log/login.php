    ...
    <div class="container-login100">
        <div class="wrap-login100" style="padding:40px;">
            <div class="login100-pic js-tilt">
                <center><img src="<?= base_url('img/logo.png'); ?>" alt="IMG"></center>
            </div>

            <!-- ✅ FORM LOGIN -->
            <form class="login100-form validate-form" action="<?= base_url('web/login'); ?>" method="post">
                <span class="login100-form-title" style="padding:40px;">
                    Silahkan Login
                </span>

                <?php
                    // ✅ Tampilkan pesan error/sukses dari session flashdata
                ...
                <!-- ✅ GANTI SEMUA LINK .html MENJADI ROUTE CODEIGNITER -->
                <div class="text-center p-t-136">
                    <a class="txt2" href="<?= base_url('web'); ?>">
                        Beranda
                        <i class="fa fa-home m-l-5" aria-hidden="true"></i>
                    </a>
                    <span> | </span>
                    <a class="txt2" href="<?= base_url('web/user_register'); ?>">
                        Buat Akun
